...
class CatalogController < ApplicationController
  ...
  def index
    ...
    if matched_in_text_field.try(:keys).try(:present?)
      ...
      @snippets = SnippetHelper.build_snippets(solr_documents: @document_list, query: @query_for_captions, matches: fixed_matches)
    end
  end
    ...
    respond_to do |format|
      format.html do
        ...
        if can? :play, @pbcore
          ...
          # Move this to the PBCorePresenter after outside_urls (plural) branch is merged?
